...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('am_tasktemplates_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_am_tasktemplates_parent_id');
    ...
    {
        Schema::dropIfExists('am_tasktemplates_audit');
    }
};
