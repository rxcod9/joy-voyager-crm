...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('surveyquestionoptions_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_surveyquestionoptions_parent_id');
    ...
    {
        Schema::dropIfExists('surveyquestionoptions_audit');
    }
};
