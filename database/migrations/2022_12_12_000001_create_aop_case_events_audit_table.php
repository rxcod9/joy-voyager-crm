...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('aop_case_events_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_aop_case_events_parent_id');
    ...
    {
        Schema::dropIfExists('aop_case_events_audit');
    }
};
