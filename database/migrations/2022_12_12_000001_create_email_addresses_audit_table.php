...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('email_addresses_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_email_addresses_parent_id');
    ...
    {
        Schema::dropIfExists('email_addresses_audit');
    }
};
