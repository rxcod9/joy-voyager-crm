...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('fp_event_locations_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_fp_event_locations_parent_id');
    ...
    {
        Schema::dropIfExists('fp_event_locations_audit');
    }
};
