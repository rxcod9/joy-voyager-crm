...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('aod_indexevent_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_aod_indexevent_parent_id');
    ...
    {
        Schema::dropIfExists('aod_indexevent_audit');
    }
};
