...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('surveyquestionresponses_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_surveyquestionresponses_parent_id');
    ...
    {
        Schema::dropIfExists('surveyquestionresponses_audit');
    }
};
