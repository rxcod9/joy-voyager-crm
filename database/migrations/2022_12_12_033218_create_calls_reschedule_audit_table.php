...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('calls_reschedule_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_calls_reschedule_parent_id');
    ...
    {
        Schema::dropIfExists('calls_reschedule_audit');
    }
};
