...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('opportunities_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_opportunities_parent_id');
    ...
    {
        Schema::dropIfExists('opportunities_audit');
    }
};
