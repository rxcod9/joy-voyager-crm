...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('aok_knowledgebase_categories', function (Blueprint $table) {
            ...
            $table->uuid('aok_knowledge_base_categories_id')->nullable();

            $table->index(['aok_knowledgebase_id', 'aok_knowledge_base_categories_id'], 'aok_knowledgebase_categories_alt');
            $table->timestamps();
            $table->softDeletes();
        });
    }
