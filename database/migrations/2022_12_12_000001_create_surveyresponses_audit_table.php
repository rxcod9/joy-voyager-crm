...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('surveyresponses_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_surveyresponses_parent_id');
    ...
    {
        Schema::dropIfExists('surveyresponses_audit');
    }
};
