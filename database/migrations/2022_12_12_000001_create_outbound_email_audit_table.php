...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('outbound_email_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_outbound_email_parent_id');
    ...
    {
        Schema::dropIfExists('outbound_email_audit');
    }
};
