...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('aos_line_item_groups_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_aos_line_item_groups_parent_id');
    ...
    {
        Schema::dropIfExists('aos_line_item_groups_audit');
    }
};
