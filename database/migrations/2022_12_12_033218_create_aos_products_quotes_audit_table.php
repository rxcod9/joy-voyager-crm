...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('aos_products_quotes_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_aos_products_quotes_parent_id');
    ...
    {
        Schema::dropIfExists('aos_products_quotes_audit');
    }
};
