...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('aok_knowledgebase_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_aok_knowledgebase_parent_id');
    ...
    {
        Schema::dropIfExists('aok_knowledgebase_audit');
    }
};
