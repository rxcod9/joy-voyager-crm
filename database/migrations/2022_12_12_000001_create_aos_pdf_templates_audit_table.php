...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('aos_pdf_templates_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_aos_pdf_templates_parent_id');
    ...
    {
        Schema::dropIfExists('aos_pdf_templates_audit');
    }
};
