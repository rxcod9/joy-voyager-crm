...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('jjwg_address_cache_audit', function (Blueprint $table) {
            $table->comment('');
            $table->uuid('id')->primary();
            $table->uuid('parent_id')->index('idx_jjwg_address_cache_parent_id');
    ...
    {
        Schema::dropIfExists('jjwg_address_cache_audit');
    }
};
