...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function menusTranslations()
    {
        ...
        $_item = $this->findMenuItem(__('joy-voyager-crm::seeders.menu_items.contacts'));
        if ($_item->exists) {
