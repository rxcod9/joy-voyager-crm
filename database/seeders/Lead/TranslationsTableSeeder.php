...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function menusTranslations()
    {
        ...
        $_item = $this->findMenuItem(__('joy-voyager-crm::seeders.menu_items.leads'));
        if ($_item->exists) {
