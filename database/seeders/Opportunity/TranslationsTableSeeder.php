...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function opportunitiesTranslations()
    {
        ...
        //
        $cat = Voyager::model('Opportunity')->where('name', 'opportunity-1')->first();
        if ($cat->exists) {
        ...
        $cat = Voyager::model('Opportunity')->where('name', 'opportunity-2')->first();
        if ($cat->exists) {
    ...
    private function menusTranslations()
    {
        ...
        $_item = $this->findMenuItem(__('joy-voyager-crm::seeders.menu_items.opportunities'));
        if ($_item->exists) {
