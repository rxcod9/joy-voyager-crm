...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function menusTranslations()
    {
        ...
        $_item = $this->findMenuItem(__('joy-voyager-crm::seeders.menu_items.emails'));
        if ($_item->exists) {
