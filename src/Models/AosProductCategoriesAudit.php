...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\AosProductCategoriesAuditFactory;
 ...
 */
class AosProductCategoriesAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'aos_product_categories_audit';
    ...
    */
    ...
    {
        return AosProductCategoriesAuditFactory::new();
    }
}
