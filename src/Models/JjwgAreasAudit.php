...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\JjwgAreasAuditFactory;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\SoftDeletes;

/**
 * Class JjwgAreasAudit
 *
 * @property string      $id
 ...
 */
class JjwgAreasAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'jjwg_areas_audit';
    ...
    */
    ...
    {
        return JjwgAreasAuditFactory::new();
    }
}
