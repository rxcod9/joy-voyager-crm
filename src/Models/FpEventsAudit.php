...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\FpEventsAuditFactory;
 ...
 */
class FpEventsAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'fp_events_audit';
    ...
    */
    ...
    {
        return FpEventsAuditFactory::new();
    }
}
