...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\OpportunitiesAuditFactory;
 ...
 */
class OpportunitiesAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'opportunities_audit';
    ...
    */
    ...
    {
        return OpportunitiesAuditFactory::new();
    }
}
