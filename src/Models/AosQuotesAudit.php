...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\AosQuotesAuditFactory;
 ...
 */
class AosQuotesAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'aos_quotes_audit';
    ...
    */
    ...
    {
        return AosQuotesAuditFactory::new();
    }
}
