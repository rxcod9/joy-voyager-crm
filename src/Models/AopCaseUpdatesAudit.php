...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\AopCaseUpdatesAuditFactory;
 ...
 */
class AopCaseUpdatesAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'aop_case_updates_audit';
    ...
    */
    ...
    {
        return AopCaseUpdatesAuditFactory::new();
    }
}
