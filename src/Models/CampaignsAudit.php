...
use Joy\VoyagerCrm\Database\Factories\CampaignsAuditFactory;
 ...
 */
class CampaignsAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'campaigns_audit';
    ...
    */
    ...
    {
        return CampaignsAuditFactory::new();
    }
}
