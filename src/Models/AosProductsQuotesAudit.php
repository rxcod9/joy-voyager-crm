...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\AosProductsQuotesAuditFactory;
 ...
 */
class AosProductsQuotesAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'aos_products_quotes_audit';
    ...
    */
    ...
    {
        return AosProductsQuotesAuditFactory::new();
    }
}
