 ...
 * @property string|null $fp_events_leads_1fp_events_ida
 * @property string|null $fp_events_leads_1leads_idb
 ...
 */
class FpEventsLeads1C extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    // use Traits\CreatedModifiedBy;

    protected $table     = 'fp_events_leads_1_c';
