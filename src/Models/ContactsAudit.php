...
use Joy\VoyagerCrm\Database\Factories\ContactsAuditFactory;
 ...
 */
class ContactsAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'contacts_audit';
    ...
    */
    ...
    {
        return ContactsAuditFactory::new();
    }
}
