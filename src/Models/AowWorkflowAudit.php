...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\AowWorkflowAuditFactory;
 ...
 */
class AowWorkflowAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'aow_workflow_audit';
    ...
    */
    ...
    {
        return AowWorkflowAuditFactory::new();
    }
}
