...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\AccountsAuditFactory;
 ...
 */
class AccountsAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'accounts_audit';
    ...
    */
    ...
    {
        return AccountsAuditFactory::new();
    }
}
