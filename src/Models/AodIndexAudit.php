...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\AodIndexAuditFactory;
 ...
 */
class AodIndexAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'aod_index_audit';
    ...
    */
    ...
    {
        return AodIndexAuditFactory::new();
    }
}
