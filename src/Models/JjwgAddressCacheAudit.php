...
use Carbon\Carbon;
use Joy\VoyagerCrm\Database\Factories\JjwgAddressCacheAuditFactory;
 ...
 */
class JjwgAddressCacheAudit extends Model
{
    use SoftDeletes;
    use Traits\Uuids;
    ...
    protected $table     = 'jjwg_address_cache_audit';
    ...
    */
    ...
    {
        return JjwgAddressCacheAuditFactory::new();
    }
}
